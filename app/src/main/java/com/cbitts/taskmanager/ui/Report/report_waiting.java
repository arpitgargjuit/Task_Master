...
//                all.setTextColor(ContextCompat.getColor(getContext(), R.color.white));
    ...
    private void getData() {
        ...
        Waiting_report_dataSetter modelClass_pending_report = new Waiting_report_dataSetter(getContext(),recyclerView, this.getActivity(), loading,R.id.main_task, Filter.getFilter());
